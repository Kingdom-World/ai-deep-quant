...
const USAGE_GUIDE = [
  '📖 AI深度量化 使用指南',
  '1. 首页查看市场概况（6 大指数，每 10 秒自动刷新）、我的收藏、AI 今日推荐。',
  ...
  '3. 「AI 潜力分析」页面对个股做五因子（趋势/动量/量能/波动/位置）评分。',
  '4. 「策略回测」页面支持 MA 双均线 / RSI / 买入持有 策略的历史回测。',
  '5. 问我「分析 AAPL」「600519 怎么样」可直接获取个股解读；问「今天推荐什么」获取股票池评分。',
